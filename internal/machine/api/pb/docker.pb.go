...
var file_internal_machine_api_pb_docker_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x65, 0x32, 0xf4, 0x05, 0x0a, 0x06, 0x44, 0x6f, 0x63, 0x6b, 0x65, 0x72, 0x12, 0x4c,
...
var file_internal_machine_api_pb_docker_proto_depIdxs = []int32{
	...
	1,  // 16: api.Docker.CreateContainer:output_type -> api.CreateContainerResponse
	3,  // 17: api.Docker.InspectContainer:output_type -> api.InspectContainerResponse
	20, // 18: api.Docker.StartContainer:output_type -> google.protobuf.Empty
	20, // 19: api.Docker.StopContainer:output_type -> google.protobuf.Empty
	7,  // 20: api.Docker.ListContainers:output_type -> api.ListContainersResponse
	20, // 21: api.Docker.RemoveContainer:output_type -> google.protobuf.Empty
	11, // 22: api.Docker.PullImage:output_type -> api.JSONMessage
	13, // 23: api.Docker.InspectImage:output_type -> api.InspectImageResponse
	16, // 24: api.Docker.InspectRemoteImage:output_type -> api.InspectRemoteImageResponse
	1,  // 25: api.Docker.CreateServiceContainer:output_type -> api.CreateContainerResponse
