...
const file_internal_machine_api_pb_cluster_proto_rawDesc = "" +
	...
	"\bmachines\x18\x01 \x03(\v2\x12.api.MachineMemberR\bmachines\"\xbb\x01\n" +
	"\x14UpdateMachineRequest\x12\x1d\n" +
	"\n" +
	"machine_id\x18\x01 \x01(\tR\tmachineId\x12\x17\n" +
	"\x04name\x18\x02 \x01(\tH\x00R\x04name\x88\x01\x01\x12)\n" +
	"\tpublic_ip\x18\x03 \x01(\v2\a.api.IPH\x01R\bpublicIp\x88\x01\x01\x12)\n" +
	"\tendpoints\x18\x04 \x03(\v2\v.api.IPPortR\tendpointsB\a\n" +
	"\x05_nameB\f\n" +
	"\n" +
	"_public_ip\"C\n" +
	"\x15UpdateMachineResponse\x12*\n" +
	"\amachine\x18\x01 \x01(\v2\x10.api.MachineInfoR\amachine\"&\n" +
	...
	"\rUpdateMachine\x12\x19.api.UpdateMachineRequest\x1a\x1a.api.UpdateMachineResponse\x12B\n" +
	"\rRemoveMachine\x12\x19.api.RemoveMachineRequest\x1a\x16.google.protobuf.Empty\x127\n" +
