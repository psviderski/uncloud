...
func (*Service_Container) Descriptor() ([]byte, []int) {
	return file_internal_machine_api_pb_machine_proto_rawDescGZIP(), []int{11, 0}
}
...
var file_internal_machine_api_pb_machine_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x2e, 0x0a, 0x12, 0x47,
	...
	0x28, 0x09, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xc3, 0x01, 0x0a, 0x12,
	...
	0x49, 0x70, 0x73, 0x32, 0xa2, 0x05, 0x0a, 0x07, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x12,
	...
	0x69, 0x73, 0x69, 0x74, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3d,
	0x0a, 0x0a, 0x47, 0x65, 0x74, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x16, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x1a, 0x17, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x56, 0x65,
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x40, 0x0a,
...
var file_internal_machine_api_pb_machine_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_internal_machine_api_pb_machine_proto_goTypes = []any{
	...
	(*InspectMachineResponse)(nil),          // 7: api.InspectMachineResponse
	(*MachineDetails)(nil),                  // 8: api.MachineDetails
	(*TokenResponse)(nil),                   // 9: api.TokenResponse
	(*ResetRequest)(nil),                    // 10: api.ResetRequest
	(*Service)(nil),                         // 11: api.Service
	(*InspectServiceRequest)(nil),           // 12: api.InspectServiceRequest
	(*InspectServiceResponse)(nil),          // 13: api.InspectServiceResponse
	(*InspectWireGuardNetworkResponse)(nil), // 14: api.InspectWireGuardNetworkResponse
	(*WireGuardPeer)(nil),                   // 15: api.WireGuardPeer
	(*Service_Container)(nil),               // 16: api.Service.Container
	(*IP)(nil),                              // 17: api.IP
	(*IPPrefix)(nil),                        // 18: api.IPPrefix
...
var file_internal_machine_api_pb_machine_proto_depIdxs = []int32{
	...
	17, // 1: api.MachineInfo.public_ip:type_name -> api.IP
	18, // 2: api.NetworkConfig.subnet:type_name -> api.IPPrefix
	17, // 3: api.NetworkConfig.management_ip:type_name -> api.IP
	19, // 4: api.NetworkConfig.endpoints:type_name -> api.IPPort
	18, // 5: api.InitClusterRequest.network:type_name -> api.IPPrefix
	17, // 6: api.InitClusterRequest.public_ip:type_name -> api.IP
	...
	8,  // 10: api.InspectMachineResponse.machines:type_name -> api.MachineDetails
	20, // 11: api.MachineDetails.metadata:type_name -> api.Metadata
	0,  // 12: api.MachineDetails.machine:type_name -> api.MachineInfo
	16, // 13: api.Service.containers:type_name -> api.Service.Container
	11, // 14: api.InspectServiceResponse.service:type_name -> api.Service
	15, // 15: api.InspectWireGuardNetworkResponse.peers:type_name -> api.WireGuardPeer
	21, // 16: api.WireGuardPeer.last_handshake_time:type_name -> google.protobuf.Timestamp
	22, // 17: api.Machine.CheckPrerequisites:input_type -> google.protobuf.Empty
	22, // 18: api.Machine.GetVersion:input_type -> google.protobuf.Empty
	4,  // 19: api.Machine.InitCluster:input_type -> api.InitClusterRequest
	6,  // 20: api.Machine.JoinCluster:input_type -> api.JoinClusterRequest
	22, // 21: api.Machine.Token:input_type -> google.protobuf.Empty
	...
	10, // 25: api.Machine.Reset:input_type -> api.ResetRequest
	12, // 26: api.Machine.InspectService:input_type -> api.InspectServiceRequest
	2,  // 27: api.Machine.CheckPrerequisites:output_type -> api.CheckPrerequisitesResponse
	3,  // 28: api.Machine.GetVersion:output_type -> api.GetVersionResponse
	5,  // 29: api.Machine.InitCluster:output_type -> api.InitClusterResponse
	22, // 30: api.Machine.JoinCluster:output_type -> google.protobuf.Empty
	9,  // 31: api.Machine.Token:output_type -> api.TokenResponse
	0,  // 32: api.Machine.Inspect:output_type -> api.MachineInfo
	7,  // 33: api.Machine.InspectMachine:output_type -> api.InspectMachineResponse
	14, // 34: api.Machine.InspectWireGuardNetwork:output_type -> api.InspectWireGuardNetworkResponse
	22, // 35: api.Machine.Reset:output_type -> google.protobuf.Empty
	13, // 36: api.Machine.InspectService:output_type -> api.InspectServiceResponse
...
func file_internal_machine_api_pb_machine_proto_init() {
	...
	file_internal_machine_api_pb_machine_proto_msgTypes[4].OneofWrappers = []any{
