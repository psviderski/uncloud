...
var file_internal_machine_api_pb_machine_proto_rawDesc = []byte{
	...
	0xf6, 0x01, 0x0a, 0x0b, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12,
	...
	0x75, 0x62, 0x6c, 0x69, 0x63, 0x49, 0x70, 0x12, 0x34, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c,
	0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x4d, 0x61,
	0x63, 0x68, 0x69, 0x6e, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xae, 0x01, 0x0a, 0x0d, 0x4e, 0x65, 0x74,
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x32, 0xc3, 0x03, 0x0a, 0x07, 0x4d, 0x61, 0x63, 0x68,
	...
	0x70, 0x69, 0x2e, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x32,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x37, 0x5a,
...
var file_internal_machine_api_pb_machine_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_internal_machine_api_pb_machine_proto_goTypes = []any{
	...
	nil,                                // 11: api.MachineInfo.LabelsEntry
	(*Service_Container)(nil),          // 12: api.Service.Container
	(*IP)(nil),                         // 13: api.IP
	(*IPPrefix)(nil),                   // 14: api.IPPrefix
	(*IPPort)(nil),                     // 15: api.IPPort
...
var file_internal_machine_api_pb_machine_proto_depIdxs = []int32{
	...
	13, // 1: api.MachineInfo.public_ip:type_name -> api.IP
	11, // 2: api.MachineInfo.labels:type_name -> api.MachineInfo.LabelsEntry
	14, // 3: api.NetworkConfig.subnet:type_name -> api.IPPrefix
	13, // 4: api.NetworkConfig.management_ip:type_name -> api.IP
	15, // 5: api.NetworkConfig.endpoints:type_name -> api.IPPort
	14, // 6: api.InitClusterRequest.network:type_name -> api.IPPrefix
	13, // 7: api.InitClusterRequest.public_ip:type_name -> api.IP
	...
	12, // 11: api.Service.containers:type_name -> api.Service.Container
	8,  // 12: api.InspectServiceResponse.service:type_name -> api.Service
	16, // 13: api.Machine.CheckPrerequisites:input_type -> google.protobuf.Empty
	3,  // 14: api.Machine.InitCluster:input_type -> api.InitClusterRequest
	5,  // 15: api.Machine.JoinCluster:input_type -> api.JoinClusterRequest
	16, // 16: api.Machine.Token:input_type -> google.protobuf.Empty
	16, // 17: api.Machine.Inspect:input_type -> google.protobuf.Empty
	7,  // 18: api.Machine.Reset:input_type -> api.ResetRequest
	9,  // 19: api.Machine.InspectService:input_type -> api.InspectServiceRequest
	2,  // 20: api.Machine.CheckPrerequisites:output_type -> api.CheckPrerequisitesResponse
	4,  // 21: api.Machine.InitCluster:output_type -> api.InitClusterResponse
	16, // 22: api.Machine.JoinCluster:output_type -> google.protobuf.Empty
	6,  // 23: api.Machine.Token:output_type -> api.TokenResponse
	0,  // 24: api.Machine.Inspect:output_type -> api.MachineInfo
	16, // 25: api.Machine.Reset:output_type -> google.protobuf.Empty
	10, // 26: api.Machine.InspectService:output_type -> api.InspectServiceResponse
