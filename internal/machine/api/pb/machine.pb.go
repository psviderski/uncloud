...
var file_internal_machine_api_pb_machine_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x06, 0x73, 0x74, 0x64, 0x44, 0x65, 0x76, 0x22, 0x2e, 0x0a,
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x22, 0x73, 0x0a,
	...
	0x78, 0x69, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f,
	0x61, 0x64, 0x32, 0xd9, 0x05, 0x0a, 0x07, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x12, 0x4d,
	...
	,
...
var file_internal_machine_api_pb_machine_proto_goTypes = []any{
	...
	(*ExecCommandRequest)(nil),              // 16: api.ExecCommandRequest
	(*ExecCommandResponse)(nil),             // 17: api.ExecCommandResponse
...
var file_internal_machine_api_pb_machine_proto_depIdxs = []int32{
	...
	23, // 5: api.InitClusterRequest.network:type_name -> api.IPPrefix
	22, // 6: api.InitClusterRequest.public_ip:type_name -> api.IP
	24, // 7: api.InitClusterRequest.wireguard_endpoints:type_name -> api.IPPort
	...
	18, // 11: api.JoinClusterRequest.min_store_version:type_name -> api.JoinClusterRequest.MinStoreVersionEntry
	7,  // 12: api.InspectMachineResponse.machines:type_name -> api.MachineDetails
	25, // 13: api.MachineDetails.metadata:type_name -> api.Metadata
	0,  // 14: api.MachineDetails.machine:type_name -> api.MachineInfo
	19, // 15: api.MachineDetails.rtts:type_name -> api.MachineDetails.RttsEntry
	20, // 16: api.MachineDetails.store_version:type_name -> api.MachineDetails.StoreVersionEntry
	21, // 17: api.Service.containers:type_name -> api.Service.Container
	...
	26, // 20: api.WireGuardPeer.last_handshake_time:type_name -> google.protobuf.Timestamp
	27, // 21: api.RTTStats.median:type_name -> google.protobuf.Duration
	27, // 22: api.RTTStats.std_dev:type_name -> google.protobuf.Duration
	15, // 23: api.MachineDetails.RttsEntry.value:type_name -> api.RTTStats
	28, // 24: api.Machine.CheckPrerequisites:input_type -> google.protobuf.Empty
	...
	28, // 27: api.Machine.Token:input_type -> google.protobuf.Empty
	28, // 28: api.Machine.Inspect:input_type -> google.protobuf.Empty
	28, // 29: api.Machine.InspectMachine:input_type -> google.protobuf.Empty
	28, // 30: api.Machine.InspectWireGuardNetwork:input_type -> google.protobuf.Empty
	9,  // 31: api.Machine.Reset:input_type -> api.ResetRequest
	11, // 32: api.Machine.InspectService:input_type -> api.InspectServiceRequest
	29, // 33: api.Machine.MachineLogs:input_type -> api.LogsRequest
	16, // 34: api.Machine.ExecCommand:input_type -> api.ExecCommandRequest
	2,  // 35: api.Machine.CheckPrerequisites:output_type -> api.CheckPrerequisitesResponse
	4,  // 36: api.Machine.InitCluster:output_type -> api.InitClusterResponse
	28, // 37: api.Machine.JoinCluster:output_type -> google.protobuf.Empty
	8,  // 38: api.Machine.Token:output_type -> api.TokenResponse
	0,  // 39: api.Machine.Inspect:output_type -> api.MachineInfo
	6,  // 40: api.Machine.InspectMachine:output_type -> api.InspectMachineResponse
	13, // 41: api.Machine.InspectWireGuardNetwork:output_type -> api.InspectWireGuardNetworkResponse
	28, // 42: api.Machine.Reset:output_type -> google.protobuf.Empty
	12, // 43: api.Machine.InspectService:output_type -> api.InspectServiceResponse
	30, // 44: api.Machine.MachineLogs:output_type -> api.LogEntry
	17, // 45: api.Machine.ExecCommand:output_type -> api.ExecCommandResponse
...
func file_internal_machine_api_pb_machine_proto_init() {
	...
	file_internal_machine_api_pb_machine_proto_msgTypes[17].OneofWrappers = []any{
