...
```
      ...
      --entrypoint strings   Overwrite the default ENTRYPOINT of the image. Pass an empty string "" to reset it. Can be specified multiple times or as a comma-separated list of command and arguments.
